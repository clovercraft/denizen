...
kschka_interact:
    ...
    script:
        - if <player.has_flag[silverfish_general_history]> && <player.has_flag[silverfish_world_history]>:
            ...
            - wait 1s
            - clickable kschka_general_history save:generalhistory
            - clickable kschka_world_history save:worldhistory
        ...
        - wait 1s
        - clickable kschka_explore save:explore
        - clickable kschka_history save:history
