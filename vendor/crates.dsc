...
crates_config:
    ...
    show_tripwire: true
    chests:
        light_chest_name: <aqua>Crate
        medium_chest_name: <yellow>Treasure
        heavy_chest_name: <green>Vault
...
crates_chest_light:
    ...
    display name: <green>Crate
    lore:
    - <&r>Place it to create a <green>Crate.
    flags:
        crates:
            type: light
crates_chest_medium:
    ...
    debug: false
    material: ender_chest
    display name: <yellow>Treasure Chest
    lore:
    - <&r>Place it to create a <yellow>Treasure Chest.
    flags:
        crates:
            type: medium
crates_chest_heavy:
    ...
    debug: false
    material: ender_chest
    display name: <red>Vault
    lore:
    - <&r>Place it to create a <red>Vault.
    flags:
        crates:
            type: heavy
crates_key_light:
    ...
    display name: <green>Crate Key
    lore:
    - <&r>You can open a <green>Crate<&r> with it.
    enchantments:
    - durability:1
    mechanisms:
        hides:
...
crates_key_medium:
    ...
    debug: false
    material: tripwire_hook
    display name: <yellow>Treasure Key
    lore:
    - <&r>You can open a <yellow>Treasure Chest<&r> with it.
    enchantments:
    - durability:1
    mechanisms:
        hides:
...
crates_key_heavy:
    ...
    debug: false
    material: tripwire_hook
    display name: <red>Vault Key
    lore:
    - <&r>You can open a <red>Vault<&r> with it.
    enchantments:
    - durability:1
    mechanisms:
        hides:
